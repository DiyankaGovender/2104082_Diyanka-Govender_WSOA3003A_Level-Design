...
public class LVL1_Player_RNG : MonoBehaviour
{
    ...
    {
        cardClick.Play();
        if (LVL1_battleState.playerAttackButton)
        {
            LVL1_enemy_AI.playerDamageAttackGiven = randomNumber1;
            button1.GetComponent<Button>().interactable = false;
            button1.GetComponent<Image>().color = new Color(0.3411764706f, 0.6156862745f, 1);

        }

        //if (LVL1_battleState.playerHealButton)
        //{
          //  LVL1_player_Controller.playerHealed = randomNumber1;
           // button1.GetComponent<Button>().interactable = false;
           // button1.GetComponent<Image>().color = new Color(0.3411764706f, 0.6156862745f, 1);
        //}
    ...
    public void clicked2()
    {
        ...
        if (LVL1_battleState.playerAttackButton)
        {
            LVL1_enemy_AI.playerDamageAttackGiven = randomNumber2;
       ...
       // if (LVL1_battleState.playerHealButton)
        //{
          //  LVL1_player_Controller.playerHealed = randomNumber2;
          //
            //button2.GetComponent<Button>().interactable = false;
            //utton2.GetComponent<Image>().color = new Color(0.3411764706f, 0.6156862745f, 1);
        //}
    ...
    public void clicked3()
    {
        ...
        if (LVL1_battleState.playerAttackButton)
        {
            LVL1_enemy_AI.playerDamageAttackGiven = randomNumber3;
       ...
       // if (LVL1_battleState.playerHealButton)
        //{
          //  LVL1_player_Controller.playerHealed = randomNumber3;
    ...
    public void clicked4()
    {
        ...
        if (LVL1_battleState.playerAttackButton)
        {
            LVL1_enemy_AI.playerDamageAttackGiven = randomNumber4;
        ...
        //if (LVL1_battleState.playerHealButton)
        //{
          //  LVL1_player_Controller.playerHealed = randomNumber4;
    ...
    public void clicked5()
    {
        ...
        if (LVL1_battleState.playerAttackButton)
        {
            LVL1_enemy_AI.playerDamageAttackGiven = randomNumber5;
        ...
        //if (LVL1_battleState.playerHealButton)
        //{
          //  LVL1_player_Controller.playerHealed = randomNumber5;
    ...
    public void clicked6()
    {
        ...
        if (LVL1_battleState.playerAttackButton)
        {
            LVL1_enemy_AI.playerDamageAttackGiven = randomNumber6;
       ...
       // if (LVL1_battleState.playerHealButton)
       // {
         //   LVL1_player_Controller.playerHealed = randomNumber6;
    ...
    {
        randomNumber1 = Random.Range(1, 6);
        number1.text = randomNumber1.ToString();
    }

    public void number2RNG()
    {
        randomNumber2 = Random.Range(1, 6);
    ...
    {
        randomNumber3 = Random.Range(1, 6);
